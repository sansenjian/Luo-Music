...
This plugin can be installed from this directory:

```text
plugins/third-party/restart-theme
```

After enabling the plugin, choose `Re:Start Orange White` in the render style setting.
