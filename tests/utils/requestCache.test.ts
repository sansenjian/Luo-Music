...
describe('requestCache', () => {
  ...
  describe('缓存键生成', () => {
    it('相同配置应该生成相同的缓存键', () => {
      const config1: CacheRequestConfig = { method: 'get', url: '/api/test', params: { id: 1 } }
      const config2: CacheRequestConfig = { method: 'get', url: '/api/test', params: { id: 1 } }
    ...
    it('不同配置应该生成不同的缓存键', () => {
      const config1: CacheRequestConfig = { method: 'get', url: '/api/test', params: { id: 1 } }
      const config2: CacheRequestConfig = { method: 'get', url: '/api/test', params: { id: 2 } }
