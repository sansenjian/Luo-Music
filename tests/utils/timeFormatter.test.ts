...
describe('TimeFormatter', () => {
  describe('formatTime', () => {
    ...
    it('应该处理边界值', () => {
      ...
      expect(formatTime('' as unknown as number)).toBe('00:00')
    })
  ...
  describe('formatTimeDetailed', () => {
    ...
    it('应该处理边界值', () => {
      expect(formatTimeDetailed(null as unknown as number)).toBe('00:00.00')
      expect(formatTimeDetailed(undefined as unknown as number)).toBe('00:00.00')
      expect(formatTimeDetailed(NaN)).toBe('00:00.00')
      expect(formatTimeDetailed(Infinity)).toBe('00:00.00')
  ...
  describe('formatTimeWithHours', () => {
    ...
    it('应该处理边界值', () => {
      expect(formatTimeWithHours(null as unknown as number)).toBe('00:00:00')
      expect(formatTimeWithHours(undefined as unknown as number)).toBe('00:00:00')
      expect(formatTimeWithHours(NaN)).toBe('00:00:00')
      expect(formatTimeWithHours(Infinity)).toBe('00:00:00')
