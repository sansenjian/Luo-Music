...
describe('requestConfig', () => {
  ...
  describe('importConfig', () => {
    it('should import valid config', () => {
      const newConfig = {
        cache: { enabled: false, ttl: 9999, max_size: 50, methods: ['post'], cleanup_interval: 5000 },
        ...
        logging: { enabled: false, level: 'error', log_request: false, log_response: false, log_error: false }
      }
