...
describe('requestKeyGenerator', () => {
  ...
  describe('isSameRequest', () => {
    it('should return true for identical configs', () => {
      const config1 = { url: '/api/test', method: 'get', params: { id: 1 }, data: {} }
      const config2 = { url: '/api/test', method: 'get', params: { id: 1 }, data: {} }
      expect(isSameRequest(config1, config2)).toBe(true)
    })

    it('should return false for different urls', () => {
      const config1 = { url: '/api/test1', method: 'get', params: {}, data: {} }
      const config2 = { url: '/api/test2', method: 'get', params: {}, data: {} }
      expect(isSameRequest(config1, config2)).toBe(false)
    })

    it('should return false for different methods', () => {
      const config1 = { url: '/api/test', method: 'get', params: {}, data: {} }
      const config2 = { url: '/api/test', method: 'post', params: {}, data: {} }
      expect(isSameRequest(config1, config2)).toBe(false)
    })

    it('should return false for different params', () => {
      const config1 = { url: '/api/test', method: 'get', params: { id: 1 }, data: {} }
      const config2 = { url: '/api/test', method: 'get', params: { id: 2 }, data: {} }
      expect(isSameRequest(config1, config2)).toBe(false)
    })

    it('should be case-insensitive for method', () => {
      const config1 = { url: '/api/test', method: 'GET', params: {}, data: {} }
      const config2 = { url: '/api/test', method: 'get', params: {}, data: {} }
      expect(isSameRequest(config1, config2)).toBe(true)
    })
  })
