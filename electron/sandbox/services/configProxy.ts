...
import type { AppConfig, ConfigChangeEvent, ConfigKey } from '@shared/contracts/config'

export type { AppConfig, ConfigChangeEvent, ConfigKey } from '@shared/contracts/config'
