...
LUO Music 是一个面向 Web 与 Electron 双端的音乐播放器项目，当前主线技术栈为 Vue 3、Vite 8、Pinia 3、TypeScript 6、Electron 40 和 Vitest 4。具体版本以根目录 `package.json` 为准。
...
| `docs/`    | 项目文档站与计划 / 报告归档                                                    |
| `.config/` | Prettier、Oxfmt、Vite、Vitest、Playwright、Qodana 等工具配置与本地运行环境文件 |
