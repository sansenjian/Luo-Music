...
import type { PlayMode as PlayModeType } from '../player/playMode'
...
// 导出播放模式常量和类型
export { PLAY_MODE, PLAY_MODE_LABELS, PLAY_MODE_ICONS } from '../player/playMode'
export type { PlayMode } from '../player/playMode'
