...
export const INVOKE_CHANNELS = {
  ...
  LOCAL_LIBRARY_SCAN_FOLDER: 'local-library:scan-folder',
  LOCAL_LIBRARY_SHOW_FOLDER: 'local-library:show-folder',
  LOCAL_LIBRARY_SHOW_TRACK: 'local-library:show-track',
